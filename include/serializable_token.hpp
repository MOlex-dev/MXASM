...
namespace mxasm
{
    ...
    public:
        ...
        enum class st_command : byte_t
        {
            ...
            LDY_imm = 0xA0, LDA_izx = 0xA1, LDX_imm = 0xA2, LDY_zpg = 0xA4, LDA_zpg = 0xA5, LDX_zpg = 0xA6, SMB2_zpg = 0xA7, TAY_imp = 0xA8, LDA_imm = 0xA9, TAX_imp = 0xAA,                 LDY_abs = 0xAC, LDA_abs = 0xAD, LDX_abs = 0xAE, BBS2_zpr = 0xAF,
